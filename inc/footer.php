					...
					<div class="footer-box pages">
						...
						<?php
									...
									foreach ($menu as $m) {
										...
										/* NEULOGOVAN */
										if(!isset($_SESSION["user"]) AND !in_array($m->href,["cart.php","checkout.php", "adminpanel.php"])){
											echo "<li><a href='$m->href'>$m->name</a></li>";
										}
										/* ULOGOVAN */
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2022 - <a href="https://www.instagram.com/jovan_cajic/">Jovan Cajic</a>,  All Rights Reserved.</p>
				</div>
